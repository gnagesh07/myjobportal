...
import com.cts.myjobportal.repository.UsersRepository;
import com.cts.myjobportal.services.RecruiterProfileService;
import com.cts.myjobportal.util.FileUploadUtil;
...
public class RecruiterProfileController {
	...
	public String addNew(RecruiterProfile recruiterProfile,
		...
		/*
		 * String fileName = ""; if (!multipartFile.getOriginalFilename().equals("")) {
		 * fileName = StringUtils.cleanPath(Objects.requireNonNull(multipartFile.
		 * getOriginalFilename())); recruiterProfile.setProfilePhoto(fileName); }
		 */
        RecruiterProfile savedUser = recruiterProfileService.addNew(recruiterProfile);

		/*
		 * String uploadDir = "photos/recruiter/" + savedUser.getUserAccountId(); try {
